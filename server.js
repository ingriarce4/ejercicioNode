...
app.get('/signup', function (req, res) {
  res.render('index', { title: 'practica - Signup' });
})

app.get('/signin', function (req, res) {
  res.render('index', { title: 'practica - Signin' });
})
...
app.get('/:username', function (req, res) {
  res.render('index', { title: `practica - ${req.params.username}` });
})
...
app.listen(3000, function (err) {
  ...
  console.log('practica escuchando en el puerto 3000');
})